...
impl Display for TokenType {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            TokenType::Sub => f.write_str("keyword `subtract`"),
            TokenType::Mul => f.write_str("keyword `multiply`"),
            TokenType::Div => f.write_str("keyword `divide`"),
            TokenType::Mod => f.write_str("keyword `modulo`"),
            ...
            TokenType::No => f.write_str("keyword `no`"),
            TokenType::Argument => f.write_str("keyword `argument`"),
            TokenType::Arguments => f.write_str("keyword `arguments`"),
            TokenType::Does => f.write_str("keyword `does`"),
            TokenType::Has => f.write_str("keyword `has`"),
            TokenType::Is => f.write_str("keyword `is`"),
            TokenType::Not => f.write_str("keyword `not`"),
            TokenType::Have => f.write_str("keyword `have`"),
            TokenType::Greater => f.write_str("keyword `greater`"),
            TokenType::Less => f.write_str("keyword `less`"),
            TokenType::Than => f.write_str("keyword `than`"),
            TokenType::Equal => f.write_str("keyword `equal`"),
            TokenType::Or => f.write_str("keyword `or`"),
            TokenType::Call => f.write_str("keyword `call`"),
